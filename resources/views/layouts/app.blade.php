        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                    ...
                    @else()
                        <img src="{{ asset('img/sale-logo-download.png') }}" alt="User Image" class="user-image img-circle elevation-2">
                    @endif
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <li class="user-header bg-primary">
                        @if(Auth::user()->profile_image == null)
                        <img src="{{ asset('img/sale-logo-download.png') }}" alt="User Image" class="img-circle elevation-2">
                        @else()
                        <img src="{{ asset('img/sale-logo-download.png') }}" alt="User Image" class="img-circle elevation-2">
                        @endif
                        <p>
...
<!-- Content Wrapper. Contains page content -->
    ...
    <footer class="main-footer">
        ...
        <strong>
            Copyright &copy; <?= date('Y') ?> <a>Sale Co PVT</a>.
        </strong>
        All rights reserved.
    </footer>
</div>
